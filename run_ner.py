...
def readfile(filename):
    ...
    for line in f:
        ...
        if len(tag)==2 :
           ...
           # print(tag.split('/'))
            lab=tag.split('/')[0]+tag.split('/')[1]
            #print(lab)
        label.append(lab.replace('\n',''))
...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        return ["O", "B-other", "I-other",  "B-person", "I-person", "B-organization", "I-organization", "B-location", "I-location", "[CLS]", "[SEP]"]
